        ...
        <div className="space-y-4">
            <Disclosure>
                <Disclosure.Button className="py-2 w-full bg-indigo-400 rounded-2xl p-6">
                    <p className="text-2xl font-mono text-white text-center py-2">    KELAS I</p>
                                ...
                                <div className="" key={index}>
                                    {
                                        data.class.slug === "vii-semester-1" ?
                                            <div className="flex items-start py-2">
                                                ...
                                                <div className="-mt-1">
                                                   <Link to={`/content/${data.subject.name}/${data.slug}`}>
            ...
            <Disclosure>
                <Disclosure.Button className="py-2 w-full bg-indigo-400 rounded-2xl p-6">
                    <p className="text-2xl font-mono text-white text-center py-2">    KELAS II</p>
                    <div className="flex justify-center">
                        <ArrowDownIcon className="animate-bounce w-6 text-center text-white" />
                    </div>
                </Disclosure.Button>
            ...
            <Disclosure>
                <Disclosure.Button className="py-2 w-full bg-indigo-400 rounded-2xl p-6">
                    <p className="text-2xl font-mono text-white text-center py-2">    KELAS III</p>
                    <div className="flex justify-center">
                        <ArrowDownIcon className="animate-bounce w-6 text-center text-white" />
                    </div>
                </Disclosure.Button>
            ...
            <Disclosure>
                <Disclosure.Button className="py-2 w-full bg-indigo-400 rounded-2xl p-6">
                    <p className="text-2xl font-mono text-white text-center py-2">    KELAS IV</p>
                    <div className="flex justify-center">
                        <ArrowDownIcon className="animate-bounce w-6 text-center text-white" />
                    </div>
                </Disclosure.Button>
            ...
            <Disclosure>
                <Disclosure.Button className="py-2 w-full bg-indigo-400 rounded-2xl p-6">
                    <p className="text-2xl font-mono text-white text-center py-2">    KELAS V</p>
                    <div className="flex justify-center">
                        <ArrowDownIcon className="animate-bounce w-6 text-center text-white" />
                    </div>
                </Disclosure.Button>
            ...
            <Disclosure>
                <Disclosure.Button className="py-2 w-full bg-indigo-400 rounded-2xl p-6">
                    <p className="text-2xl font-mono text-white text-center py-2">    KELAS VI</p>
                    <div className="flex justify-center">
                        <ArrowDownIcon className="animate-bounce w-6 text-center text-white" />
                    </div>
                </Disclosure.Button>
