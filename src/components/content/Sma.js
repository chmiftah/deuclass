        ...
        <div className="space-y-4">
            <Disclosure>
                <Disclosure.Button className="py-2 w-full bg-indigo-400 rounded-2xl p-6">
                    <p className="text-2xl font-mono text-white text-center py-2">    KELAS X</p>
            ...
            <Disclosure>
                <Disclosure.Button className="py-2 w-full bg-indigo-400 rounded-2xl p-6">
                    <p className="text-2xl font-mono text-white text-center py-2">    KELAS XI</p>
                    <div className="flex justify-center">
                        <ArrowDownIcon className="animate-bounce w-6 text-center text-white" />
                    </div>
                </Disclosure.Button>
            ...
            <Disclosure>
                <Disclosure.Button className="py-2 w-full bg-indigo-400 rounded-2xl p-6">
                    <p className="text-2xl font-mono text-white text-center py-2">    KELAS XII</p>
                    <div className="flex justify-center">
                        <ArrowDownIcon className="animate-bounce w-6 text-center text-white" />
                    </div>
                </Disclosure.Button>
